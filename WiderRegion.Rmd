...
# with 2 examples: Error in { : 
#  task 1 failed - "task 3 failed - "cannot allocate vector of size 396.4 Mb""
# with 500 examples Error Error in { : task 1 failed - "task 1 failed - "std::bad_alloc""
